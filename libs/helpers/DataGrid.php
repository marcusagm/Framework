...
class DataGrid
{
    ...
    private $_maxLinkPagesNumbers = 10;
    ...
    public function __construct($controller, $module = null)
    {
        ...
        $this->_module = $module;
        $this->_templatePath = FWROOT . 'libs/helpers/resource/datagrid/grid.tpl.php';
    ...
    public function setMaxLinkPagesNumbers($maxLinks)
    {
        return $this->_maxLinkPagesNumbers = (int) $maxLinks;
    }

    public function getMaxLinkPagesNumbers()
    {
        return $this->_maxLinkPagesNumbers;
    }
     ...
     */
    public function addColumnButton($buttonText, $controller, $action, $field = 'id', $modal = false)
    {
        $this->_buttons[] = array(
            'field' => $field,
            'module' => false,
    ...
    public function addColumnButtonByModule($buttonText, $module, $controller, $action, $field = 'id', $modal = false)
    {
        $this->_buttons[] = array(
            'field' => $field,
            'module' => $module,
