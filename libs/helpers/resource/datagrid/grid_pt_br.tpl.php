...
<div class="grid_pagination_area">
    <ul class="grid_pagination_actions">
        ...
        <?php if ( $this->getNextPage() != false ) { ?>
            <li class="grid_pagination_actions_next"><a href="<?php echo $this->getUrlToList( array( 'page' => $this->getNextPage(), 'sortField' => $this->getSortField(), 'sortOrder' => $this->getSortOrder(), 'filter' => $this->getFilters(), 'limit' => $this->getLimit() ) ) ?>" title="" />Próximo</a></li>
            <li class="grid_pagination_actions_last"><a href="<?php echo $this->getUrlToList( array( 'page' => $this->getLastPage(), 'sortField' => $this->getSortField(), 'sortOrder' => $this->getSortOrder(), 'filter' => $this->getFilters(), 'limit' => $this->getLimit() ) ) ?>" title="" />Último</a></li>
        <?php } else { ?>
            <li class="grid_pagination_actions_next grid_pagination_actions_inactive">Próximo</li>
            <li class="grid_pagination_actions_last grid_pagination_actions_inactive">Último</li>
        <?php } ?>
